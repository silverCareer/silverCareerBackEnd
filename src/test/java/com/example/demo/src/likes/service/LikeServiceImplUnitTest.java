...
public class LikeServiceImplUnitTest {
    ...
    class LikedUnitTests {
        ...
        void addLikesCount() {
            ...
            given(likeRepository.existsByProductIdxAndMemberEmail(eq(mockProductIdx), eq(mockEmail))) // 좋아요 기록은 없음으로 부여하고
                    .willReturn(false);
            ...
            verify(likeRepository, times(1)).existsByProductIdxAndMemberEmail(eq(mockProductIdx), eq(mockEmail)); ///검증
