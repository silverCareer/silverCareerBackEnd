    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity, CustomJwtFilter customJwtFilter) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests
                        .requestMatchers("/api/hello", "api/members", "api/authenticate", "api/login", "/api/kakao", "/api/product/category/**", "api/product/detail/**", "api/sendSMS/{phone}", "api/chat", "api/latestChat", "api/chat/update", "api/chat/create", "/ws/**", "/app/sendMessage", "/topic/**", "/api/search", "/api/checkName/**", "/api/checkEmail/**").permitAll()
